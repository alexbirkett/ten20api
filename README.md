...
#Mongo db notes
See db stats in MB ```db.stats(1024*1024)```

[Fix ‘std::runtime_error’](http://dev.mensfeld.pl/2013/11/mongodb-mongodump-terminate-called-after-throwing-an-instance-of-stdruntime_error/)
