...
var dbUrl = 'mongodb://localhost/messageById';
...
describe('message by id', function () {
    ...
    it('should be possible to update the tracker', function (done) {
        credential1request.post({url: url + '/message/by-id/528538f0d8d584853c000002', json: messageUpdate1 }, function (error, response, body) {
            assert.equal(200, response.statusCode);
    ...
    it('should not update location if latitude not set', function (done) {
        ...
        credential1request.post({url: url + '/message/by-id/528538f0d8d584853c000002', json: update }, function (error, response, body) {
            assert.equal(200, response.statusCode);
            credential1request.get({url: url + '/trackers/528538f0d8d584853c000002', json: true }, function (error, response, body) {
                assert.equal(response.statusCode, 200);
    ...
    it('updating message by serial should trigger notify_changed on tracker2 owned by user', function (done) {
        ...
        setTimeout(function() {
            complete.update_by_serial_started = true;
            credential1request.post({url: url + '/message/by-id/528538f0d8d584853c000003', json: messageUpdate1 }, function (error, response, body) {
                complete.update_by_serial = true;
                assert.equal(200, response.statusCode);
                handleComplete(complete, done);
            });
    ...
    it('should be possible for more than one user to listen for changes simultaneously', function (done) {
        ...
        setTimeout(function() {
            ...
            credential2request.post({url: url + '/message/by-id/528538f0d8d584853c000004', json: messageUpdate2 }, function (error, response, body) {
    ...
    it('server should ignore updates with uknown serials', function (done) {
        credential1request.post({url: url + '/message/by-id/528538f0d8d584853c000005', json: messageUpdate1 }, function (error, response, body) {
    ...
    it('server should possible to update a tracker not associated with your account', function (done) {
        credential1request.post({url: url + '/message/by-id/528538f0d8d584853c000004', json: messageUpdate1 }, function (error, response, body) {
