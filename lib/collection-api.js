...
module.exports = function(collectionName){
    ...
    var findObjects = function(query, callback) {
        ...
        if (query.mongoDbQuery.limit) {
            options.limit = query.mongoDbQuery.limit;
            delete query.mongoDbQuery.limit;
        }

        var cursor = getObjectCollection().find(query.mongoDbQuery, null, options).sort(query.sort);
    ...
    return {
        ...
        get: function (req, res) {
            ...
            var query = buildQuery(req.query, req.user._id);
